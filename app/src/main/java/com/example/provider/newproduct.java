...
public class newproduct extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        code_img=findViewById(R.id.new_code);
        img_img=findViewById(R.id.new_img);

        code=findViewById(R.id.new_capture_code);
        img=findViewById(R.id.new_capture_img);
        send=findViewById(R.id.new_send);

        codigo=findViewById(R.id.new_codigo);
        costo=findViewById(R.id.new_costo);
        precio=findViewById(R.id.new_precio);
        cantidad=findViewById(R.id.new_cantidad);
        costo_total =findViewById(R.id.new_costo_total);
    ...
    private void sendData() {
        ...
        client.post("https://servicemercadoxpress.",req,new JsonHttpResponseHandler(){
            ...
            public void onSuccess(int statusCode, Header[] headers, JSONObject response) {
                ...
                try {
                    Toast.makeText(newproduct.this, ""+response.getString("message"), Toast.LENGTH_SHORT).show();
                    Intent in=new Intent(newproduct.this,MainActivity.class);
                    startActivity(in);
    ...
    private void sendImgimg(String url) {
        ...
        client.post(ip.ip,rq,new JsonHttpResponseHandler(){
            ...
            public void onSuccess(int statusCode, Header[] headers, JSONObject response) {
                super.onSuccess(statusCode, headers, response);
                try {
                    Glide.with(newproduct.this).load(response.getString("url")).into(img_img);
    ...
    private void sendCodeimg(String url) {
        ...
        client.post(ip.ip,rq,new JsonHttpResponseHandler(){
            ...
            public void onSuccess(int statusCode, Header[] headers, JSONObject response) {
                super.onSuccess(statusCode, headers, response);
                try {
                    Glide.with(newproduct.this).load(response.getString("url")).into(code_img);
                    id=response.getString("_id");
                } catch (JSONException e) {
                    e.printStackTrace();
                }
